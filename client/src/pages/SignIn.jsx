        ...
        <div className="flex-1">
          <Link to="/" className="dark:text-white">
            <div className="flex items-center">
              ...
              <span className="font-bold text-4xl font-poppins text-cyan-950 dark:text-slate-200">marifah.id</span>
            </div>
          </Link>
      ...
      {showToast && (
        <div className="fixed top-0 right-0 gap-4">
          <Toast color="success" className="bg-green-500 dark:bg-green-500 w-72">
            ...
            <div className="ml-3 text-sm font-semibold text-white">Sign In berhasil! </div>
