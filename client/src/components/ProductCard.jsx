    ...
    <Card className="max-w-sm h-full flex flex-col group bg-purple-200/10 rounded-xl border shadow-indigo-500/20  shadow-xl transition hover:border-teal-500 hover:shadow-teal-500/20 dark:hover:border-pink-500 dark:hover:shadow-pink-500/20">
      <Link
        ...
        <div className="relative h-64 overflow-hidden rounded-md">
          <img
            className="absolute w-full h-full object-cover transition-transform duration-300 ease-in-out group-hover:scale-125"
            src={product.image}
            alt={product.name}
            loading="lazy"
          />
        ...
        <div className="mt-2 flex h-20 flex-col">
          <div className="flex">
            <h5 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white mt-3 line-clamp-2">
              {product.name}
            </h5>
          </div>
        </div>
        <div className="flex">
          <div className="flex">
            <span className="text-lg text-gray-900 font-semibold dark:text-white">
