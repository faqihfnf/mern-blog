...
export default function DashboardPosts() {
  ...
  return (
    <div className="table-auto overflow-x-scroll md:mx-auto py-3 scrollbar scrollbar-track-slate-100 scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500">
